...
import 'package:coin_manager/pages/dashboard/dashboard.dart';
...
class _LoginPageView extends StatefulView<LoginPage, _LoginPageController> {
    ...
    return Column(
      children: <Widget>[
        ...
        _entryField("Password",
            textEditingController: state.passwordController, isPassword: true),
      ],
    );
  }
